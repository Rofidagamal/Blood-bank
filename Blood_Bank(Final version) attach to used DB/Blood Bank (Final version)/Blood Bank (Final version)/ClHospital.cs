...
namespace boodbank2
{
    class ClHospital
    {
        ...
        public static void insert(String text1, String text2, String text3) //this function insert new hospital
        {
            try { 
            connection();
            cnn.Open();
            string Sinsert = "insert into hospital values (  '" + text1 + "' , '" + text2 + "' , '" + text3 + "')";
        ...
        public static void delete(String s) //this function deletes  specific hospital and its relations with other tables
        {
            try { 
            connection();
            cnn.Open();
            string d = "delete from hospital where name='" + s + "'";
            string d1 = "delete from patient where hospital_name ='" + s + "'";
            MySqlCommand cmd = new MySqlCommand(d, cnn);
            MySqlCommand cmd1 = new MySqlCommand(d1, cnn);
            MySqlDataAdapter adabter = new MySqlDataAdapter();
            adabter.DeleteCommand = new MySqlCommand(d, cnn);
            adabter.DeleteCommand.ExecuteNonQuery();
            adabter.DeleteCommand = new MySqlCommand(d1, cnn);
            adabter.DeleteCommand.ExecuteNonQuery();
            cmd.Dispose();
            cnn.Close();
        ...
        public static void update(String s1, String s2) //this function updates phone  for specific hospital
        {
            try { 
            connection();
            cnn.Open();
            string d = "update hospital set phone= '" + s2 + "' where name='" + s1 + "'";
            MySqlCommand cmd = new MySqlCommand(d, cnn);
            MySqlDataAdapter adabter = new MySqlDataAdapter();
